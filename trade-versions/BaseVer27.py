...
try:
    with open('/projects/Ver27/stats/alerts_stat.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27/stats/day_check.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27/stats_4h/alerts_stat_4h.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27/stats_4h/alerts_stat_1h.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27/stats_4h/hour_check_1h.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27/channel_price.txt', 'r') as f:
        last = f.read()
        channel_price = json.loads(last)

    with open('/projects/Ver27/channel_time.txt', 'r') as f:
        last = f.read()
        channel_time = json.loads(last)

    with open('/projects/Ver27/alerts_MT.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27/channel_cond.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27/count_trades.txt', 'r') as f:
        last = f.read()
...
try:
    ...
    with open('/projects/Ver27/lim_amp.txt', 'r') as f:
        last = f.read()
        lim_amp = json.loads(last)

    with open('/projects/Ver27/lim_atr.txt', 'r') as f:
        last = f.read()
        lim_atr = json.loads(last)

    '''
    with open('/projects/Ver27/f1.txt', 'r') as f:
        last = f.read()
        f1 = json.loads(last)

    with open('/projects/Ver27/f2.txt', 'r') as f:
        last = f.read()
        f2 = json.loads(last)
    '''

    with open('/projects/Ver27/current_minute_prices.txt', 'r') as f:
        last = f.read()
        current_minute_prices = json.loads(last)

    with open('/projects/Ver27/current_minute_start.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27/max_average_bar_price.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27/time_last_kline.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27/red_stop.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27/orange_stop.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27/yellow_stop.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27/last_atr.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27/orange_ten_min_start.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27/ten_min_start.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27/sl_time.txt', 'r') as f:
        last = f.read()
...
def calc_prev_min_chandles(channel_data_price: dict[list[float]], symb: str, i: int):
    ...
    try:
        ...
        bot.send_message(error_tg, f"ver 27 fail calc_prev_min_chandles, min([]), i={i}, symb={symb}, er={er}")  ### отладка - поиск min([])   -eg-
...
def calc_limits(high_ser: dict[list[pd.core.series.Series]],
    ...
    if len(atr_prev) == 0:
        bot.send_message(error_tg, f"ver 27 len(atr_prev) == 0 in calc_limits, i={i}, symb={symb}")  ### отладка - поиск min([])   -eg-
...
def ver_trade(channel_data_price, symb, price_last_alert_algo_1, time_last_alert_algo_1, time_tick, price, alerts,
                ...
                green_psar, k0, k1, price_acc, price_last_dinamic_sl, time_check_sl, check_volatility, q70, col_trades, number_of_trades, last_10_avg_vol, zatupok): 
        
        def kline_MT_9(i,k):    
            if check_wtp[symb][i] == 0:
                if price_acc[symb] == []:
                    bot.send_message(error_tg, f'ver 27 price_acc[{symb}] == [] in kline_MT_9({i}, {k})')  ### отладка - поиск min([])   -eg-
...
#                         print(last_atr[symb])
        ...
        #                         print(last_atr[symb])
            ...
            #                       last_atr[symb] / price * 100, "%")               ### Для отладки - EG
...
##################################################### Конец вставки 3 SL
        ...
        if alerts[symb][1] >= 1 and time_tick < time_last_alert_algo_1[symb][1] + 2.1 * 60 * 60 * 1000:
            try:
                ...
                # pass
                bot.send_message(error_tg, f'ver 27 kline_MT(1,k) fail {symb}\n\n{e}')
...
def save():
    try:
        with open('/projects/Ver27/channel_price.txt', 'w') as file:
            file.write(json.dumps(channel_price))
                
        with open('/projects/Ver27/channel_time.txt', 'w') as file:
            file.write(json.dumps(channel_time))

        with open('/projects/Ver27/alerts_MT.txt', 'w') as file:
            file.write(json.dumps(alerts_MT)) 

        with open('/projects/Ver27/channel_cond.txt', 'w') as file:
            file.write(json.dumps(channel_cond))   

        with open(f'/projects/Ver27/stats/{str(day_check)}_stat.txt', 'w') as file:
            file.write(json.dumps(alerts_stat))

        with open('/projects/Ver27/stats/alerts_stat.txt', 'w') as file:
            file.write(json.dumps(alerts_stat))
            
        with open('/projects/Ver27/stats/day_check.txt', 'w') as file:
            file.write(json.dumps(day_check))

        with open('/projects/Ver27/stats_4h/alerts_stat.txt', 'w') as file:
            file.write(json.dumps(alerts_stat_4h))

        with open('/projects/Ver27/stats_4h/alerts_stat_1h.txt', 'w') as file:
            file.write(json.dumps(alerts_stat_1h))
            
        with open('/projects/Ver27/stats_4h/hour_check_1h.txt', 'w') as file:
            file.write(json.dumps(hour_check_1h))
        
        with open('/projects/Ver27/sl_time.txt', 'w') as file:
            file.write(json.dumps(sl_time))

        with open('/projects/Ver27/rsl_time.txt', 'w') as file:
        ...
        with open('/projects/Ver27/high_ser.txt', 'w') as file:
        ...
        with open('/projects/Ver27/low_ser.txt', 'w') as file:
        ...
        with open('/projects/Ver27/close_ser.txt', 'w') as file:
            file.write(json.dumps(close_ser_dict))
        del close_ser_dict 

        with open('/projects/Ver27/lim_amp.txt', 'w') as file:
            file.write(json.dumps(lim_amp))

        with open('/projects/Ver27/lim_atr.txt', 'w') as file:
            file.write(json.dumps(lim_atr))
        '''
        with open('/projects/Ver27/f1.txt', 'w') as file:
            file.write(json.dumps(f1))

        with open('/projects/Ver27/f2.txt', 'w') as file:
            file.write(json.dumps(f2))
        '''
        with open('/projects/Ver27/current_minute_start.txt', 'w') as file:
            file.write(json.dumps(current_minute_start))

        with open('/projects/Ver27/current_minute_prices.txt', 'w') as file:
            file.write(json.dumps(current_minute_prices))

        with open('/projects/Ver27/count_trades.txt', 'w') as file:
            file.write(json.dumps(count_trades))

        with open('/projects/Ver27/time_last_kline.txt', 'w') as file:
            file.write(json.dumps(time_last_kline))

        with open('/projects/Ver27/red_stop.txt', 'w') as file:
            file.write(json.dumps(red_stop))

        with open('/projects/Ver27/orange_stop.txt', 'w') as file:
            file.write(json.dumps(orange_stop))
        
        with open('/projects/Ver27/yellow_stop.txt', 'w') as file:
            file.write(json.dumps(yellow_stop))

        with open('/projects/Ver27/last_atr.txt', 'w') as file:
            file.write(json.dumps(last_atr))

        with open('/projects/Ver27/orange_ten_min_start.txt', 'w') as file:
            file.write(json.dumps(orange_ten_min_start))

        with open('/projects/Ver27/ten_min_start.txt', 'w') as file:
            file.write(json.dumps(ten_min_start))

        with open('/projects/Ver27/max_average_bar_price.txt', 'w') as file:
...
def screen(symb, i, df, time_last_alert_algo_1, price_last_alert_algo_1, df_vol):
        ...
        ######################### Конец вставки "Для отрисовки стоп-лоссов" - EG 
            ...
            if len(df['Low']) == 0:
                bot.send_message(error_tg, f'ver 27 len(df["Low"]) == 0 in screen({symb}, {i})')  ### отладка - поиск min([])   -eg-
            ...
            if len(df['Low'][(ind[0]+1):ind_2_line]) == 0:
                bot.send_message(error_tg, f'ver 27 len(df["Low"][(ind[0]+1):ind_2_line]) == 0 in screen({symb}, {i})')  ### отладка - поиск min([])   -eg-                
...
############################# Конец вставки "Oтрисовка стоп-лоссов" - EG 
            ...
            #if percent_high >= 3:
                #bot.send_photo(wtp_screen_tg, open(f'/projects/Ver27/mt_screen/screen{symb}.jpeg','rb'), caption=cap)
