...
try:
    with open('/projects/Ver9t/stats/alerts_stat.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver9t/stats/day_check.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver9t/stats_4h/alerts_stat_4h.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver9t/stats_4h/alerts_stat_1h.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver9t/stats_4h/hour_check_1h.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver9t/channel_price.txt', 'r') as f:
        last = f.read()
        channel_price = json.loads(last)

    with open('/projects/Ver9t/channel_time.txt', 'r') as f:
        last = f.read()
        channel_time = json.loads(last)

    with open('/projects/Ver9t/alerts_MT.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver9t/channel_cond.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver9t/count_trades.txt', 'r') as f:
        last = f.read()
...
try:
    ...
    a1_data_ver9 = pd.read_csv('/projects/Ver9t/a1_data_ver9.csv', delimiter=',')
...
def save():
    try:
        with open('/projects/Ver9t/channel_price.txt', 'w') as file:
            file.write(json.dumps(channel_price))
        
        with open('/projects/Ver9t/channel_time.txt', 'w') as file:
            file.write(json.dumps(channel_time))

        with open('/projects/Ver9t/alerts_MT.txt', 'w') as file:
            file.write(json.dumps(alerts_MT)) 

        with open('/projects/Ver9t/channel_cond.txt', 'w') as file:
            file.write(json.dumps(channel_cond))   

        with open(f'/projects/Ver9t/stats/{str(day_check)}_stat.txt', 'w') as file:
            file.write(json.dumps(alerts_stat))

        with open('/projects/Ver9t/stats/alerts_stat.txt', 'w') as file:
            file.write(json.dumps(alerts_stat))
        
        with open('/projects/Ver9t/stats/day_check.txt', 'w') as file:
            file.write(json.dumps(day_check))

        with open('/projects/Ver9t/stats_4h/alerts_stat.txt', 'w') as file:
            file.write(json.dumps(alerts_stat_4h))

        with open('/projects/Ver9t/stats_4h/alerts_stat_1h.txt', 'w') as file:
            file.write(json.dumps(alerts_stat_1h))
        
        with open('/projects/Ver9t/stats_4h/hour_check_1h.txt', 'w') as file:
            file.write(json.dumps(hour_check_1h))

        with open('/projects/Ver9t/count_trades.txt', 'w') as file:
            file.write(json.dumps(count_trades))

        a1_data_ver9.to_csv('/projects/Ver9t/a1_data_ver9.csv', index=False) 
