...
try:
    with open('/projects/Ver27_a/stats/alerts_stat.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27_a/stats/day_check.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27_a/stats_4h/alerts_stat_4h.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27_a/stats_4h/alerts_stat_1h.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27_a/stats_4h/hour_check_1h.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27_a/channel_price.txt', 'r') as f:
        last = f.read()
        channel_price = json.loads(last)

    with open('/projects/Ver27_a/channel_time.txt', 'r') as f:
        last = f.read()
        channel_time = json.loads(last)

    with open('/projects/Ver27_a/alerts_MT.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27_a/channel_cond.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27_a/count_trades.txt', 'r') as f:
        last = f.read()
...
try:
    ...
    with open('/projects/Ver27_a/lim_amp.txt', 'r') as f:
        last = f.read()
        lim_amp = json.loads(last)

    with open('/projects/Ver27_a/lim_atr.txt', 'r') as f:
        last = f.read()
        lim_atr = json.loads(last)

    # with open('/projects/Ver27_a/f1.txt', 'r') as f:
    #     last = f.read()
    #     f1 = json.loads(last)

    # with open('/projects/Ver27_a/f2.txt', 'r') as f:
    #     last = f.read()
    #     f2 = json.loads(last)

    with open('/projects/Ver27_a/current_minute_prices.txt', 'r') as f:
        last = f.read()
        current_minute_prices = json.loads(last)

    with open('/projects/Ver27_a/current_minute_start.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27_a/max_average_bar_price.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27_a/time_last_kline.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27_a/red_stop.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27_a/orange_stop.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27_a/yellow_stop.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27_a/last_atr.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27_a/orange_ten_min_start.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27_a/ten_min_start.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver27_a/sl_time.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver23/rsl_time.txt', 'r') as f:
        last = f.read()
...
def calc_prev_min_chandles(channel_data_price: dict[list[float]], symb: str, 
    ...
    try:
        ...
        bot.send_message(error_tg, f"ver 27_a fail calc_prev_min_chandles, min([]), i={i}, symb={symb}, er={er}")  ### отладка - поиск min([])   -nk-
...
def calc_limits(high_ser: dict[list[pd.core.series.Series]],
    ...
    if len(atr_prev) == 0:
        bot.send_message(error_tg, f"ver 27_a len(atr_prev) == 0 in calc_limits, i={i}, symb={symb}")  ### отладка - поиск min([])   -nk-
...
#     amp = (high_ser[symb].rolling(3).max() - low_ser[symb].rolling(3).min())
...
def ver_trade(channel_data_price, symb, price_last_alert_algo_1, time_last_alert_algo_1, time_tick, price, alerts,
                ...
                green_psar, k0, k1, price_acc, price_last_dinamic_sl, time_check_sl, check_volatility, q70, col_trades, number_of_trades, last_10_avg_vol, zatupok, antifrod_MT): 
        
        def kline_MT_9(i,k):    
            if check_wtp[symb][i] == 0:
                if price_acc[symb] == []:
                    bot.send_message(error_tg, f'ver 27_a price_acc[{symb}] == [] in kline_MT_9({i}, {k})')  ### отладка - поиск min([])   -nk-
...
#                         print(last_atr[symb])
            ...
            elif alerts_MT[symb][i] == 1 and len(channel_price[symb][i]) == 0 and price >= price_last_alert_algo_1[symb][i] * 1.005 and antifrod_MT[symb][i]:
                channel_price[symb][i] = channel_price[symb][i] + [price]
                channel_time[symb][i] = channel_time[symb][i] + [time_tick]
                alerts_MT[symb][i] = 2
        ...
        #                         print(last_atr[symb])
            ...
            # открытие сделки 
            ...
            elif  antifrod_MT[symb][i] and (((channel_data_cline_3m[symb][i][-1] > 1.6 * k[15]) & (all(elem > 1.6 * k[16] for elem in channel_data_cline_3m[symb][i][-1 - 60:-1])) and len(channel_time[symb][i]) > 0) or (price > price_last_alert_algo_1[symb][i] * 1.005 and len(channel_time[symb][i]) == 0)) and\
                    ...
                    (len(channel_price[symb][i]) == 0 or (len(channel_price[symb][i]) >= 2 and price > max(channel_price[symb][i]) * 1.003)) and\
                    ...
                    (price < price_acc[symb][-1] * 1.01 and price < price_acc[symb][-2] * 1.01): # вход
                        channel_price[symb][i] = channel_price[symb][i] + [price]
                        channel_time[symb][i] = channel_time[symb][i] + [time_tick]
                        alerts_MT[symb][i] = 2
            ...
            # Проверка временем стопов (4 мин. для O, 2 мин. для Y, 40 сек. для O+Y)
                  ...
                  orange_stop[symb][i] != None and price > orange_stop[symb][i] and price > yellow_stop[symb][i]):
                    sl_time[symb][i] = None        ### сброс времени при возврате цены выше стопов
                    
            elif (alerts_MT[symb][i] == 2 and sl_time[symb][i] and yellow_stop[symb][i] != None and\
                  orange_stop[symb][i] != None and\
                  time_tick > sl_time[symb][i] + PARAMS["sl_time"] * 60 * 1000):  ### 4 минуты
                    channel_price[symb][i] = channel_price[symb][i] + [price]
                    channel_time[symb][i] = channel_time[symb][i] + [time_tick]
                    alerts_MT[symb][i] = 1
...
#                         print(last_atr[symb])
            ...
            # открытие сделки 
                    ...
                    (number_of_trades[symb][-1] < q70[symb][-1] and col_trades < q70[symb][-1]): # вход
                    channel_price[symb][i] = channel_price[symb][i] + [price]
                    channel_time[symb][i] = channel_time[symb][i] + [time_tick]
                    alerts_MT[symb][i] = 2
                    channel_cond[symb][i] = channel_cond[symb][i] + ['ops']
...
##################################################### Конец вставки 3 SL
        ...
        if alerts[symb][0] >= 1 and time_tick < time_last_alert_algo_1[symb][0] + 2.1 * 60 * 60 * 1000:
            try:
                ...
                # pass
                bot.send_message(error_tg, f'ver 27 kline_MT(0,k) fail {symb}\n\n{e}')
        ...
        if alerts[symb][1] >= 1 and time_tick < time_last_alert_algo_1[symb][1] + 2.1 * 60 * 60 * 1000:
            try:
                ...
                # pass
                bot.send_message(error_tg, f'ver 27_a kline_MT(1,k) fail {symb}\n\n{e}')
...
def rewrite(symb, price, time, channel_data_price, price_acc, high_acc, low_acc):
    ...
    try:
        ...
        bot.send_message(error_tg, f'rewrite 25\n\n{e}')
    


def save():
    try:
        with open('/projects/Ver27_a/channel_price.txt', 'w') as file:
            file.write(json.dumps(channel_price))
                
        with open('/projects/Ver27_a/channel_time.txt', 'w') as file:
            file.write(json.dumps(channel_time))

        with open('/projects/Ver27_a/alerts_MT.txt', 'w') as file:
            file.write(json.dumps(alerts_MT)) 

        with open('/projects/Ver27_a/channel_cond.txt', 'w') as file:
            file.write(json.dumps(channel_cond))   

        with open(f'/projects/Ver27_a/stats/{str(day_check)}_stat.txt', 'w') as file:
            file.write(json.dumps(alerts_stat))

        with open('/projects/Ver27_a/stats/alerts_stat.txt', 'w') as file:
            file.write(json.dumps(alerts_stat))
            
        with open('/projects/Ver27_a/stats/day_check.txt', 'w') as file:
            file.write(json.dumps(day_check))

        with open('/projects/Ver27_a/stats_4h/alerts_stat.txt', 'w') as file:
            file.write(json.dumps(alerts_stat_4h))

        with open('/projects/Ver27_a/stats_4h/alerts_stat_1h.txt', 'w') as file:
            file.write(json.dumps(alerts_stat_1h))
            
        with open('/projects/Ver27_a/stats_4h/hour_check_1h.txt', 'w') as file:
            file.write(json.dumps(hour_check_1h))
        
        with open('/projects/Ver27_a/sl_time.txt', 'w') as file:
            file.write(json.dumps(sl_time))

        with open('/projects/Ver27_a/rsl_time.txt', 'w') as file:
        ...
        with open('/projects/Ver27_a/high_ser.txt', 'w') as file:
        ...
        with open('/projects/Ver27_a/low_ser.txt', 'w') as file:
        ...
        with open('/projects/Ver27_a/close_ser.txt', 'w') as file:
            file.write(json.dumps(close_ser_dict))
        del close_ser_dict 

        with open('/projects/Ver27_a/lim_amp.txt', 'w') as file:
            file.write(json.dumps(lim_amp))

        with open('/projects/Ver27_a/lim_atr.txt', 'w') as file:
            file.write(json.dumps(lim_atr))
        '''
        with open('/projects/Ver27_a/f1.txt', 'w') as file:
            file.write(json.dumps(f1))

        with open('/projects/Ver27_a/f2.txt', 'w') as file:
            file.write(json.dumps(f2))
        '''
        with open('/projects/Ver27_a/current_minute_start.txt', 'w') as file:
            file.write(json.dumps(current_minute_start))

        with open('/projects/Ver27_a/current_minute_prices.txt', 'w') as file:
            file.write(json.dumps(current_minute_prices))

        with open('/projects/Ver27_a/count_trades.txt', 'w') as file:
            file.write(json.dumps(count_trades))

        with open('/projects/Ver27_a/time_last_kline.txt', 'w') as file:
            file.write(json.dumps(time_last_kline))

        with open('/projects/Ver27_a/red_stop.txt', 'w') as file:
            file.write(json.dumps(red_stop))

        with open('/projects/Ver27_a/orange_stop.txt', 'w') as file:
            file.write(json.dumps(orange_stop))
        
        with open('/projects/Ver27_a/yellow_stop.txt', 'w') as file:
            file.write(json.dumps(yellow_stop))

        with open('/projects/Ver27_a/last_atr.txt', 'w') as file:
            file.write(json.dumps(last_atr))

        with open('/projects/Ver27_a/orange_ten_min_start.txt', 'w') as file:
            file.write(json.dumps(orange_ten_min_start))

        with open('/projects/Ver27_a/ten_min_start.txt', 'w') as file:
            file.write(json.dumps(ten_min_start))

        with open('/projects/Ver27_a/max_average_bar_price.txt', 'w') as file:
...
def screen(symb, i, df, time_last_alert_algo_1, price_last_alert_algo_1, df_vol):
        ...
        ######################### Конец вставки "Для отрисовки стоп-лоссов" -nk 
            ...
            df['Low'] = df['Low'].astype(float)
            if len(df['Low']) == 0:
                bot.send_message(error_tg, f'ver 27_a len(df["Low"]) == 0 in screen({symb}, {i})')  ### отладка - поиск min([])   -nk-
            ...
            if len(df['Low'][(ind[0]+1):ind_2_line]) == 0:
                bot.send_message(error_tg, f'ver 27 len(df["Low"][(ind[0]+1):ind_2_line]) == 0 in screen({symb}, {i})')  ### отладка - поиск min([])   -nk-                
...
############################# Конец вставки "Oтрисовка стоп-лоссов" -nk 
            ...
            #if percent_high >= 3:
                #bot.send_photo(wtp_screen_tg, open(f'/projects/Ver27_a/mt_screen/screen{symb}.jpeg','rb'), caption=cap)
            ...
            return f_id, trade_str
                ...
                bot.send_message(error_tg, f'a1_v27_a fail screen {symb} i={i}\n\n{e}')
