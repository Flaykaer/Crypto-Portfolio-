...
try:
    with open('/projects/Ver35/stats/alerts_stat.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver35/stats/day_check.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver35/stats_4h/alerts_stat_4h.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver35/stats_4h/alerts_stat_1h.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver35/stats_4h/hour_check_1h.txt', 'r') as f:
        last = f.read()
...
try:
    ...
    with open('/projects/Ver35/channel_price.txt', 'r') as f:
        last = f.read()
        channel_price = json.loads(last)
    with open('/projects/Ver35/channel_time.txt', 'r') as f:
        last = f.read()
        channel_time = json.loads(last)
    with open('/projects/Ver35/alerts_MT.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver35/channel_cond.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver35/count_trades.txt', 'r') as f:
        last = f.read()
...
try:
    ...
    with open('/projects/Ver35/lim_amp.txt', 'r') as f:
        last = f.read()
        lim_amp = json.loads(last)

    with open('/projects/Ver35/lim_atr.txt', 'r') as f:
        last = f.read()
        lim_atr = json.loads(last)

    with open('/projects/Ver35/current_minute_prices.txt', 'r') as f:
        last = f.read()
        current_minute_prices = json.loads(last)

    with open('/projects/Ver35/current_minute_start.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver35/max_average_bar_price.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver35/time_last_kline.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver35/orange_ten_min_start.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver35/ten_min_start.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver35/sl_time.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver35/green_mile.txt', 'r') as f:
        last = f.read()
        green_mile = json.loads(last)

    with open('/projects/Ver35/green_mile_time.txt', 'r') as f:
        last = f.read()
        green_mile_time = json.loads(last)

    with open('/projects/Ver35/green_mile_price.txt', 'r') as f:
        last = f.read()
        green_mile_price = json.loads(last)

    with open('/projects/Ver35/on_w4.txt', 'r') as f:
        last = f.read()
        on_w4 = json.loads(last)

    with open('/projects/Ver35/on_w4_price.txt', 'r') as f:
        last = f.read()
        on_w4_price = json.loads(last)

    with open('/projects/Ver35/on_w4_time.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver35/max_price.txt', 'r') as f:
        last = f.read()
        max_price = json.loads(last)

    with open('/projects/Ver35/stop.txt', 'r') as f:
        last = f.read()
...
try:
    with open('/projects/Ver35/rsl_time.txt', 'r') as f:
        last = f.read()
...
def ver_trade(channel_data_price, symb, price_last_alert_algo_1, time_last_alert_algo_1, time_tick, price, alerts,
                ...
                green_psar, k0, k1, price_acc, price_last_dinamic_sl, time_check_sl, check_volatility, q70, col_trades, number_of_trades, antifrod_3, last_10_avg_vol, zatupok): 
        
        def kline_MT_9(i,k):    
            if check_wtp[symb][i] == 0:
                if price_acc[symb] == []:
                    bot.send_message(error_tg, f'ver 35 price_acc[{symb}] == [] in kline_MT_9({i}, {k})')  ### отладка - поиск min([])   -nk-
...
##################################################### Конец вставки 3 SL
        ...
        if alerts[symb][0] >= 1 and time_tick < time_last_alert_algo_1[symb][0] + 2.1 * 60 * 60 * 1000:
            try:
                ...
                # pass
                bot.send_message(error_tg, f'ver 35 kline_MT(0,k) fail {symb}\n\n{e}')
        ...
        if alerts[symb][1] >= 1 and time_tick < time_last_alert_algo_1[symb][1] + 2.1 * 60 * 60 * 1000:
            try:
                ...
                # pass
                bot.send_message(error_tg, f'ver 35 kline_MT(1,k) fail {symb}\n\n{e}')
...
def rewrite(symb, price, time, channel_data_price, price_acc, high_acc, low_acc):
    ...
    try:
        ...
        bot.send_message(error_tg, f'rewrite 35\n\n{e}')
    


def save():
    try:
        with open('/projects/Ver35/channel_price.txt', 'w') as file:
            file.write(json.dumps(channel_price))
                
        with open('/projects/Ver35/channel_time.txt', 'w') as file:
            file.write(json.dumps(channel_time))

        with open('/projects/Ver35/alerts_MT.txt', 'w') as file:
            file.write(json.dumps(alerts_MT)) 

        with open('/projects/Ver35/channel_cond.txt', 'w') as file:
            file.write(json.dumps(channel_cond))   

        with open(f'/projects/Ver35/stats/{str(day_check)}_stat.txt', 'w') as file:
            file.write(json.dumps(alerts_stat))

        with open('/projects/Ver35/stats/alerts_stat.txt', 'w') as file:
            file.write(json.dumps(alerts_stat))
            
        with open('/projects/Ver35/stats/day_check.txt', 'w') as file:
            file.write(json.dumps(day_check))

        with open('/projects/Ver35/stats_4h/alerts_stat.txt', 'w') as file:
            file.write(json.dumps(alerts_stat_4h))

        with open('/projects/Ver35/stats_4h/alerts_stat_1h.txt', 'w') as file:
            file.write(json.dumps(alerts_stat_1h))
            
        with open('/projects/Ver35/stats_4h/hour_check_1h.txt', 'w') as file:
            file.write(json.dumps(hour_check_1h))
        
        with open('/projects/Ver35/sl_time.txt', 'w') as file:
            file.write(json.dumps(sl_time))

        with open('/projects/Ver35/rsl_time.txt', 'w') as file:
        ...
        with open('/projects/Ver35/high_ser.txt', 'w') as file:
        ...
        with open('/projects/Ver35/low_ser.txt', 'w') as file:
        ...
        with open('/projects/Ver35/close_ser.txt', 'w') as file:
            file.write(json.dumps(close_ser_dict))
        del close_ser_dict 

        with open('/projects/Ver35/lim_amp.txt', 'w') as file:
            file.write(json.dumps(lim_amp))

        with open('/projects/Ver35/lim_atr.txt', 'w') as file:
            file.write(json.dumps(lim_atr))

        with open('/projects/Ver35/current_minute_start.txt', 'w') as file:
            file.write(json.dumps(current_minute_start))

        with open('/projects/Ver35/current_minute_prices.txt', 'w') as file:
            file.write(json.dumps(current_minute_prices))

        with open('/projects/Ver35/count_trades.txt', 'w') as file:
            file.write(json.dumps(count_trades))

        with open('/projects/Ver35/time_last_kline.txt', 'w') as file:
            file.write(json.dumps(time_last_kline))

        with open('/projects/Ver35/red_stop.txt', 'w') as file:
            file.write(json.dumps(red_stop))

        with open('/projects/Ver35/orange_stop.txt', 'w') as file:
            file.write(json.dumps(orange_stop))
        
        with open('/projects/Ver35/yellow_stop.txt', 'w') as file:
            file.write(json.dumps(yellow_stop))

        with open('/projects/Ver35/last_atr.txt', 'w') as file:
            file.write(json.dumps(last_atr))

        with open('/projects/Ver35/orange_ten_min_start.txt', 'w') as file:
            file.write(json.dumps(orange_ten_min_start))

        with open('/projects/Ver35/ten_min_start.txt', 'w') as file:
            file.write(json.dumps(ten_min_start))

        with open('/projects/Ver35/max_average_bar_price.txt', 'w') as file:
            file.write(json.dumps(max_average_bar_price))
        
        with open('/projects/Ver35/green_mile.txt', 'w') as file:
            file.write(json.dumps(green_mile))
        with open('/projects/Ver35/green_mile_price.txt', 'w') as file:
            file.write(json.dumps(green_mile_price))
        with open('/projects/Ver35/green_mile_time.txt', 'w') as file:
            file.write(json.dumps(green_mile_time))
        with open('/projects/Ver35/on_w4.txt', 'w') as file:
            file.write(json.dumps(on_w4))
        with open('/projects/Ver35/on_w4_price.txt', 'w') as file:
            file.write(json.dumps(on_w4_price))
        with open('/projects/Ver35/on_w4_time.txt', 'w') as file:
            file.write(json.dumps(on_w4_time))
        with open('/projects/Ver35/max_price.txt', 'w') as file:
            file.write(json.dumps(max_price))
        with open('/projects/Ver35/stop.txt', 'w') as file:
...
def screen(symb, i, df, time_last_alert_algo_1, price_last_alert_algo_1, df_vol, df_btc, long_short_real, w30_score_real, w5_score_real, st_in_pump, volume_05_real_2):
        ...
        ######################### Конец вставки "Для отрисовки стоп-лоссов" -nk 
            ...
            features05_tpl = afrd.vol_05_calc_2(df, time_alert, first_time_trade)         ### компоненты фичи объёмов с 0.5
            ...
            df['Low'] = df['Low'].astype(float)
            if len(df['Low']) == 0:
                bot.send_message(error_tg, f'ver 35 len(df["Low"]) == 0 in screen({symb}, {i})')  ### отладка - поиск min([])   -nk-
            ...
            if len(df['Low'][(ind[0]+1):ind_2_line]) == 0:
                bot.send_message(error_tg, f'ver 35 len(df["Low"][(ind[0]+1):ind_2_line]) == 0 in screen({symb}, {i})')  ### отладка - поиск min([])   -nk-
            ...
            pcnt_limits = [100, 60, 40, 30, 20, 16, 12, 6, 3, 1.5, -1.5, -3, -6, -12, -16, -20, -30, -40, -60, -100]
            legs = (f'{legendary_100}', f'{legendary_60}', f'{legendary_40}', f'{legendary_30}', f'{legendary_20}', f'{legendary_16}', f'{p_emoji}{p_emoji}{p_emoji}', f'{p_emoji}{p_emoji}', f'{p_emoji}', '')
            try:
                description = next(dsc for ma, dsc in zip(pcnt_limits[3:-3]+[-1000], сap_name_1h) if percent_high >= max(ma, 1.5) or (percent_high < 1.5 and percent_low >= ma))
                power_emoji = next(dsc for ma, dsc in zip(pcnt_limits, legs) if max(percent_high, -percent_low) >= ma)
            except Exception:
                description = "er"
                power_emoji = ""            
            ...
            if len(df['Close'][:ind[0]]) == 0:
                bot.send_message(error_tg, f"ver 35 len(df['Close'][:ind[0]]) == 0 in screen({symb}, {i})")  ### отладка - поиск min([])   -nk-
            ...
            cap = f'ver35 {description} {symb}\n{power_emoji}\nclear_pnl: {MT_pnl_clear}%\ntake_clear_potential: {round(MT_pnl_clear/percent_high*100,2)}%'
            
            title_mess = f'\n\n\nver35 {symb}, price: {price_last_alert_algo_1[i]}, time: {time_pump}\nmax={percent_high}%, min={percent_low}%, coef={count_plus_pnl}/{count_minus_pnl}, Ind_Vol= {index_vol}, {v_string}\ntotal_pnl: {MT_pnl_total}%, clear_pnl: {MT_pnl_clear}%, count_trades: {len(MT_pnl)}, comm+sq: {round(len(MT_pnl)*0.16, 2)}%, take_potential: {round(MT_pnl_total/percent_high*100,2)}%,take_clear_potential: {round(MT_pnl_clear/percent_high*100,2)}%,\npnl_trades: {MT_pnl}, min_pcnt_before: {round(min_pcnt_befor, 2)}, status_in_pump: {st_in_pump}, 05_volume: {volume_05_real_2}, w30_score: {w30_score_real}, w5_score: {w5_score_real}, LONG/SHORT: {long_short_real}' #, PnL% = {percent_order} corr: {round(corr,2)}, corr_before: {round(corr_before,2)}, corr_before_15: {round(corr_before_15,2)}, chanel_30: {narrow_30_chanel}, chanel_5: {narrow_5_chanel},
            ### сохраняем последний трейд для отправки в wtp all
            trade_str = f'ver35: {MT_pnl_clear}% / {round(MT_pnl_clear/percent_high*100,2)}%'
...
############################# Конец вставки "Oтрисовка стоп-лоссов" -nk 
            ...
            for _, (t, p, cur_atr) in df[df.price_open > -100][["Time_for_sl", "price_open", "atr"]].iterrows():
                ...
                ysl_ser[ysl_ser > df.High.max()] = None  # = максимум цены от начала трейда минус 3*ATR
...
############################# Конец вставки "Oтрисовка стоп-лоссов" -nk 
            ...
            w30_score = afrd.w30_scoring(w30_50a)
            w5_score = afrd.w5_scoring(mean_5)
            ...
            if ind05 >= df.index[ind[0]]:
                ...
                for j in range(ind[0], ind[0] + 130):  #                      = 0
            ...
            total_score = (st_in_pump * afrd.WEIGHTS_2["sip"] + v05_mark * (afrd.WEIGHTS_2["V"] + afrd.WEIGHTS_2["05"]) + af_mark * afrd.WEIGHTS_2["R"] + w30_score * afrd.WEIGHTS_2["W"] + w5_score * afrd.WEIGHTS_2["w"])
            ...
            combo_formula_string = f'{afrd.WEIGHTS_2["sip"]}{afrd.WEIGHTS_2["vol_lim"] + afrd.WEIGHTS_2["v05_lim"]}{afrd.WEIGHTS_2["real_lim"]}{afrd.WEIGHTS_2["w30_lim"]}{afrd.WEIGHTS_2["w5_lim"]}  {afrd.WEIGHTS_2["V"]} {afrd.WEIGHTS_2["05"]} {afrd.WEIGHTS_2["R"]} {afrd.WEIGHTS_2["W"]} {afrd.WEIGHTS_2["w"]}  ({afrd.WEIGHTS_2["Total"]} Б)'
            ...
            return f_id, trade_str
                ...
                bot.send_message(error_tg, f'a1_v35 fail screen {symb} i={i}\n\n{e}')
